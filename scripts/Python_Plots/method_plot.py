...
def plot2d(data, variables ,filename):
    ...
    # save plot --->
    pdfdirectory = 'C:/Users/kahl/Documents/Images/' + filename + '.pdf'
    pgfdirectory = 'C:/Users/kahl/Documents/Images/' + filename + '.pgf'
...
def plotwitherrors(time, timeunit, means, meansunit, std):
    ...
    ax.errorbar(time, means, yerr = std, 
                marker = 'o', markersize = 2, c = 'black',
                linestyle = 'none',
                ecolor = 'black', elinewidth = 1,
                capthick = 1 , capsize = 3)

    ax.plot(time, means, color = 'black', alpha = 0.5,
